...
namespace CDOProspectClient.Infrastructure.Migrations
{
    ...
    [Migration("20230218114212_AddBuyerEntityTake2")]
    partial class AddBuyerEntityTake2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CDOProspectClient.Infrastructure.Data.Models.Admin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CDOProspectClient.Infrastructure.Data.Models.Appointment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CDOProspectClient.Infrastructure.Data.Models.Client", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CDOProspectClient.Infrastructure.Data.Models.Evaluation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CDOProspectClient.Infrastructure.Data.Models.Client", b =>
                {
                    b.HasOne("CDOProspectClient.Infrastructure.Data.Models.Appointment", "Appointment")
                        .WithOne("Client")
                        .HasForeignKey("CDOProspectClient.Infrastructure.Data.Models.Client", "AppointmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
